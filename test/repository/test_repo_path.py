...
class TestRepositoryPath:
    ...
    def test_relative_path_to_relative_path_3(self, repository_path: RepositoryPath, test_directory: Path):
    ...
    def test_relative_path_to_relative_path_4(self, repository_path: RepositoryPath, test_directory: Path):
        ...
        with patch('os.getcwd', return_value=test_directory.as_posix()):
            relative_path = repository_path.to_relative_path(f'./sub_dir/{temp_file_path.name}')
            assert relative_path == Path(f'{test_directory.name}/sub_dir/{temp_file_path.name}')
            assert relative_path.as_posix() == f'{test_directory.name}/sub_dir/{temp_file_path.name}'
